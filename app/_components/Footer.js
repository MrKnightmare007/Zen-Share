                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                            ...
                            <div className="text-center sm:text-left">
                                ...
                                <ul className="mt-8 space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a
                                            className="text-gray-700 flex justify-center sm:justify-start items-center gap-2 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                                            href="#"
                                        >
                                            Live Chat
                            ...
                            <div className="text-center sm:text-left">
                                ...
                                <ul className="mt-8 space-y-4 text-sm">
                                    <li>
                                        <a
                                            className="text-gray-700 font-medium transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75 flex items-center gap-1.5 sm:justify-start justify-center"
                                            href="#"
                                        >
                                            <svg
                                    ...
                                    <li className="flex items-start gap-1.5 sm:justify-start justify-center">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-5 w-5 text-gray-900 dark:text-white"
                                            fill="none"
                                        ...
                                        <p className="text-gray-700 font-medium transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75">
